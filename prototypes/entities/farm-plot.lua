...
ENTITY {
    ...
    name = "aoe-farm-plot",
	crafting_categories = {"aoe-category-farm-plot-flax","aoe-category-farm-plot-tea","aoe-category-farm-plot-maize","aoe-category-farm-plot-coffee","aoe-category-farm-plot-spruce-tree","aoe-category-farm-plot-apple-tree","aoe-category-farm-plot-olive-tree"},
	crafting_speed = 0.5,
