data:extend({{
    ...
    icon = "__ageofcreation__/img/items/bees/logistic-hive.png",
    icon_size = 32,
...
data:extend({{
	...
	base = {
        filename = '__ageofcreation__/img/entities/bees/bee-hive-idle.png',
        width = 256,
        height = 256,
    ...
    base_patch = {
        filename = '__ageofcreation__/img/entities/nothing.png',
        priority = 'medium',
        width = 32,
        height = 32,
        frame_count = 1,
    ...
    base_animation = {
        filename = '__ageofcreation__/img/entities/bees/bee-hive.png',
        priority = 'medium',
        width = 256,
        height = 256,
        frame_count = 4,
