...
data.raw.shortcut['give-spidertron-remote'].technology_to_unlock = 'aoc-spidertron-tech'
data.raw.shortcut['toggle-equipment-movement-bonus'].technology_to_unlock = 'aoc-equipment-tech-2'
